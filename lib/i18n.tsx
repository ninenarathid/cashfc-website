...
const DICT = {
  ...
  // One in a hundred arrives wrapped, with a line from somebody in the FC.
  "notif.popotoRare": {
    en: "{who} sent you a popoto… but this doesn't look like an ordinary popoto.",
    th: "{who} ส่ง popoto ให้คุณ… แต่เหมือน popoto อันนี้จะไม่ใช่ popoto ธรรมดา",
  },
  /* ── Prizes somebody has to hand over ─────────────────────────────── */
  // Four sentences for one prize: it was won, it was claimed, somebody said
  // something about it, it changed hands.
  "notif.prizeWin": {
    en: "You have won something. It is waiting in your inventory.",
    th: "คุณได้รับของรางวัล! ไปดูได้ที่ inventory ของคุณ",
  },
  "notif.prizeClaim": {
  ...
  "prize.inventoryHint": {
    en: "Claimed. Talk to the admins below to arrange when to meet — it leaves this list once it has been handed over.",
    th: "กดรับแล้ว คุยกับแอดมินด้านล่างเพื่อนัดเวลารับของได้เลย — พอได้รับของแล้วรายการจะหายไปจากตรงนี้",
  },
  "prize.wonOn": { en: "Won {when}", th: "ได้เมื่อ {when}" },
  "prize.claimedOn": { en: "claimed {when}", th: "กดรับเมื่อ {when}" },
  "prize.claim": { en: "Claim it", th: "กดรับของ" },
  "prize.openChat": { en: "Messages", th: "ข้อความ" },
  "prize.hideChat": { en: "Hide", th: "ซ่อน" },
  "prize.chatHint": {
    en: "Say when you are usually online and which character to whisper. An admin answers here.",
    th: "บอกเวลาที่ออนบ่อยและชื่อตัวละครที่ให้กระซิบหาได้เลย แอดมินจะตอบตรงนี้",
  },
  "prize.chatEmpty": {
    en: "Nothing said yet. Start here.",
    th: "ยังไม่มีใครพิมพ์อะไร เริ่มได้เลย",
  },
  "prize.chatSay": { en: "Write a message", th: "พิมพ์ข้อความ" },
  "prize.chatClosed": {
    en: "Handed over. This conversation is finished.",
    th: "ส่งของเรียบร้อยแล้ว ห้องนี้ปิดแล้ว",
  },
  ...
  "adm.prizeNew": { en: "A new prize", th: "เพิ่มของรางวัล" },
  ...
  "adm.prizeDraw": { en: "Drawn on", th: "สุ่มตอนไหน" },
  "adm.prizeDrawReceive": { en: "A popoto received", th: "ตอนได้รับ popoto" },
  "adm.prizeDrawGive": { en: "A popoto sent", th: "ตอนส่ง popoto" },
  "adm.prizeDrawDaily": { en: "Once a day", th: "วันละครั้ง" },
  "adm.prizeDrawReceiveWhy": {
    en: "Rolled on every popoto arriving, and won by whoever it was given to. Popular members get the most chances.",
    th: "สุ่มทุกครั้งที่มี popoto ส่งเข้ามา คนที่ได้รับเป็นคนได้รางวัล คนที่มีคนให้เยอะจะมีสิทธิ์มากกว่า",
  },
  "adm.prizeDrawGiveWhy": {
    en: "Rolled on every popoto sent, and won by the sender. Somebody giving fifty a day gets fifty chances.",
    th: "สุ่มทุกครั้งที่ส่ง popoto คนส่งเป็นคนได้รางวัล ใครส่งวันละ 50 ลูกก็ได้ลุ้น 50 ครั้ง",
  },
  ...
  "adm.prizeOff": { en: "paused", th: "พักอยู่" },
  "adm.prizePause": { en: "Pause", th: "พัก" },
  "adm.prizeResume": { en: "Resume", th: "เปิดใหม่" },
  "adm.prizeGone": { en: "Deleted", th: "ลบแล้ว" },
  "adm.prizeDropAsk": {
    en: "Delete “{name}”? Prizes already won stay with the people who won them.",
    th: "ลบ “{name}” ไหม? ของที่มีคนได้ไปแล้วยังอยู่กับเขาเหมือนเดิม",
  },
  "adm.prizeQueue": { en: "Who is waiting", th: "คิวรอรับของ" },
  "adm.prizeWaiting": { en: "{n} not handed over yet", th: "ยังไม่ได้ส่ง {n} รายการ" },
  "adm.prizeNothingWaiting": { en: "all handed over", th: "ส่งครบแล้ว" },
  "adm.prizeNoWins": { en: "Nobody has won anything yet.", th: "ยังไม่มีใครได้ของรางวัล" },
  "adm.prizeClaimedAt": { en: "claimed {when}", th: "กดรับ {when}" },
  "adm.prizeDeliveredAt": { en: "handed over {when}", th: "ส่งแล้ว {when}" },
  "adm.prizeDeliver": { en: "Handed over", th: "ส่งของแล้ว" },
  "adm.prizeDelivered": { en: "Closed", th: "ปิดรายการแล้ว" },
  "adm.prizeDeliverAsk": {
    en: "Mark “{name}” as handed over to {who}? The conversation closes and it leaves their inventory.",
    th: "ยืนยันว่าส่ง “{name}” ให้ {who} แล้วใช่ไหม? ห้องแชทจะปิดและของจะหายจาก inventory ของเขา",
  },
  "rare.title": { en: "A rare popoto", th: "Popoto แรร์" },
  "rare.unwrap": { en: "Unwrap it", th: "แกะห่อ" },
  "rare.openInInventory": { en: "Open it in your profile", th: "ไปแกะห่อที่หน้าโปรไฟล์" },
  "rare.again": { en: "Read it again", th: "อ่านอีกครั้ง" },
  "rare.fromSender": { en: "A popoto from {who}", th: "popoto จาก {who}" },
  "rare.fromSomebody": { en: "A popoto from a friend", th: "popoto จากเพื่อน" },
  "rare.shelf": { en: "Rare popoto", th: "Popoto แรร์" },
  "rare.inventory": { en: "Rare popoto inventory", th: "Inventory popoto แรร์" },
  "rare.inventoryHint": {
    en: "Pick up to 10 to show on your profile. Everybody who visits it can read their lines.",
    th: "เลือกโชว์บนหน้าโปรไฟล์ได้สูงสุด 10 ชิ้น ทุกคนที่เข้ามาดูโปรไฟล์จะกดอ่านข้อความได้",
  },
  "rare.inventoryWrapped": {
    en: "{n} still wrapped — press one to open it. Opened ones can go on your profile, up to 10.",
    th: "ยังไม่ได้แกะ {n} ห่อ — กดเพื่อแกะได้เลย ชิ้นที่แกะแล้วเลือกโชว์บนโปรไฟล์ได้สูงสุด 10 ชิ้น",
  },
  "rare.onShow": { en: "{n}/{max} on show", th: "โชว์อยู่ {n}/{max}" },
  "rare.show": { en: "Show", th: "โชว์" },
  "rare.shown": { en: "On show", th: "✓ โชว์อยู่" },
  "rare.tapToOpen": { en: "Tap to open", th: "กดเพื่อแกะ" },
  "rare.cardWrapped": { en: "Still wrapped", th: "ยังไม่ได้แกะ" },
  "rare.cardSecret": { en: "What's inside is a surprise — press to open it.", th: "ข้างในเป็นอะไร ต้องแกะถึงจะรู้ — กดเพื่อแกะ" },
  "rare.cardGot": { en: "Received", th: "ได้รับเมื่อ" },
  "rare.cardOpened": { en: "Opened", th: "แกะเมื่อ" },
  /* ── Admin: the lines inside a rare popoto ─────────────────────────── */
  "adm.blessings": { en: "Rare popoto", th: "Popoto แรร์" },
  ...
  "adm.rareOffWhy": {
    ...
    th: "popoto ทุกลูกเป็นลูกธรรมดาจนกว่าจะเปิด กรอกรสและข้อความให้ครบก่อนได้เลย",
  },
  "adm.rareNothingReady": {
    en: "No flavour is ready yet (a flavour needs at least one line in use).",
  ...
  "adm.rareOnAsk": {
    ...
    th: "เปิดใช้ Popoto แรร์ไหม? ตั้งแต่ popoto ลูกถัดไป ทุกคนมีโอกาสได้รับ ตอนนี้มีรสที่พร้อม {n} รส",
  },
  "adm.rareOffAsk": {
    en: "Turn rare popoto off? Gifts already received stay on everybody's shelf; no new ones will arrive.",
    th: "ปิด Popoto แรร์ไหม? ของที่ทุกคนได้ไปแล้วยังอยู่ครบ แต่จะไม่มีลูกใหม่ออกมาอีก",
  },
  ...
  "adm.flavorNoEn": { en: "No English name yet", th: "ยังไม่มีชื่ออังกฤษ" },
  "adm.flavorTierMoved": {
    en: "Moving tier only changes what is sent from now on — gifts already sent keep the tier they came with.",
    th: "ย้ายระดับจะมีผลกับที่ส่งหลังจากนี้เท่านั้น ของที่ส่งไปแล้วยังเป็นระดับเดิม",
  },
  ...
  "adm.flavorSentKept": {
    en: "Gifts already sent keep the name, picture, line and author they were sent with; saving changes what is sent from now on.",
    th: "ของที่ส่งไปแล้วจะเก็บชื่อ รูป คำคม และคนคิดแบบเดิมไว้ การบันทึกมีผลกับที่ส่งหลังจากนี้",
  },
  "adm.quote": { en: "The line inside", th: "คำคมในห่อ" },
  "adm.quoteTh": { en: "Thai", th: "ภาษาไทย" },
  "adm.quoteEn": { en: "English", th: "ภาษาอังกฤษ" },
  "adm.quoteAuthor": { en: "Written by (FC member)", th: "คนคิด (สมาชิก FC)" },
  "adm.quoteAuthorChange": { en: "Change", th: "เปลี่ยนคนคิด" },
  "adm.quoteAuthorTyped": { en: "(not linked to a member)", th: "(ไม่ได้ผูกกับสมาชิก)" },
  "adm.quoteNoTh": { en: "No Thai yet", th: "ยังไม่มีภาษาไทย" },
  "adm.quoteNoEn": { en: "No English yet", th: "ยังไม่มีภาษาอังกฤษ" },
  "adm.quoteNone": { en: "No line yet — this flavour is never picked.", th: "ยังไม่มีคำคม — รสนี้จะไม่ถูกสุ่ม" },
  "adm.quoteNeedAuthor": { en: "Pick who wrote it.", th: "เลือกคนคิดก่อนบันทึก" },
  "adm.flavorAdd": { en: "Add flavour", th: "เพิ่มรส" },
  "adm.flavorTierOdds": { en: "{pct}% of rares", th: "{pct}% ของแรร์ทั้งหมด" },
  "adm.flavorEmpty": {
    en: "Nothing ready (a flavour with its line): rolls for this tier step down to the one below.",
    th: "ยังไม่มีรสที่พร้อม (รสที่มีคำคม): ถ้าสุ่มได้ระดับนี้จะลดไปใช้ระดับถัดลงมา",
  },
  "adm.flavorEmptyRare": {
    en: "Nothing ready (a flavour with its line): a Rare roll leaves the popoto ordinary.",
    th: "ยังไม่มีรสที่พร้อม (รสที่มีคำคม): ถ้าสุ่มได้ Rare popoto จะเป็นลูกธรรมดา",
  },
  "notif.popotoPost": {
