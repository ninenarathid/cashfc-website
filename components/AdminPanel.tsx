...
export default function AdminPanel(
  ...
  return (
    <main className="pt-7">
      ...
      {/* ── Saying something on the site ── */}
      {/* Three audiences and three shapes, but one decision: what goes on
          the site today. Stacked as separate cards they read as unrelated
          tools; side by side you can see which one you actually want. */}
      <AdminTabs tabs={[
        ...
        { key: "anns", label: t("adm.anns"), body: (
          <>
            <div className="mt-3 flex flex-col gap-2">
              {aEditing !== null && (
        ...
        { key: "posts", label: t("adm.posts"), body: (
          <>
            <div className="mt-3 flex flex-col gap-2">
              <div className="flex flex-wrap gap-2">
