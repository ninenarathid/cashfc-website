      ...
      <div className="grid gap-5 border-t border-line px-4 py-4 sm:grid-cols-2">
        ...
        <div className="sm:col-span-2">
          ...
          <p className="mt-3 text-[12.5px] leading-relaxed text-muted">
            ...
            Logs, answering &ldquo;who could show a newcomer this job?&rdquo; — so it
            only shows from Expert up. It weighs each parse by how many kills back it,
            because a number from two pulls describes nothing, and by how hard the
