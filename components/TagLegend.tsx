...
function Chip({ t }: { t: string }) {
  return (
    <span className={`inline-flex items-center gap-1.5 whitespace-nowrap rounded-full border px-2.5 py-[3px] text-meta font-medium ${
...
function Group({ title, tags, th }:
  ...
  return (
    <div>
      <div className="mb-1.5 font-data text-label uppercase tracking-[0.14em] text-muted">
      ...
      <dl className="flex flex-col gap-1.5">
        {tags.map((t) => (
          <div key={t} className="flex flex-wrap items-baseline gap-x-2 gap-y-0.5">
            <dt><Chip t={t} /></dt>
            <dd className="text-ui leading-relaxed text-muted">
              {tagHelp(t, th ? "th" : "en")}
            </dd>
          </div>
        ))}
      ...
      <div className="border-t border-line px-4 py-4">
        ...
        <div className="grid gap-5 sm:grid-cols-2">
          ...
          <div className="sm:col-span-2">
            ...
            {th ? (
              <>
                <p className="text-ui leading-[1.85] text-muted">
                ...
                <p className="mt-2 text-ui leading-[1.85] text-muted">
                ...
                <div className="mt-2 rounded-lg border border-line/70 bg-card/50 px-2.5 py-2 text-ui leading-[1.8] text-muted">
                ...
                <ul className="mt-2 flex flex-col gap-1 text-ui text-muted">
                ...
                <p className="mt-3 text-ui leading-[1.85] text-muted">
              ...
              <>
                ...
                <div className="mt-2 rounded-lg border border-line/70 bg-card/50 px-2.5 py-2 text-ui leading-relaxed text-muted">
